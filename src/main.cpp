...
unsigned int DigiShield(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    unsigned int nProofOfWorkLimit = bnProofOfWorkLimit.GetCompact();;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    {
        if (pindexLast->nHeight+1 >= 20000 && pindexLast->nHeight+1 < 45000) { DiffMode = 2; }
        else if (pindexLast->nHeight+1 >= 45000) { DiffMode = 3; }
    }
